...
class PrePrayerAlarmService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val soundName = intent?.getStringExtra(EXTRA_SOUND) ?: run { stopSelf(startId); return START_NOT_STICKY }
        ...
        try {
            player = MediaPlayer().apply {
                ...
                setDataSource(resources.openRawResourceFd(resId)); prepare(); isLooping = false
    ...
    override fun onDestroy() { player?.stopSafely(); player?.release(); player = null; activeSoundName = null; super.onDestroy() }
