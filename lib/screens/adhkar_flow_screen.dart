...
import '../data/adhkar_evidence.dart';
...
class _AdhkarFlowScreenState extends State<AdhkarFlowScreen> {
  ...
  Widget _evidenceCard(AdhkarItem item) {
    final evidence = adhkarEvidence[item.id];
    if (evidence == null && item.note == null) return const SizedBox.shrink();
    final virtue = evidence?.virtue ?? item.note!;
