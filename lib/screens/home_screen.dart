...
void initState() {
super.initState();
WidgetsBinding.instance.addPostFrameCallback(() => _maybePromptBatterySettings());
}
...
return Scaffold(  
  body: Stack(  
    fit: StackFit.expand,  
    children: [  
      // خلفية المسجد بالصورة الكاملة، بتدرّج يتغيّر حسب فترة اليوم.  
      Image.asset(  
      ...
      Container(decoration: BoxDecoration(gradient: tintForPeriod(period))),  
      SafeArea(  
        child: Padding(  
...
onTap: () => Navigator.of(context).push(
MaterialPageRoute(builder: () => const SettingsScreen()),
),
),
...
borderRadius: BorderRadius.circular(20),
onTap: () => Navigator.of(context).push(
MaterialPageRoute(builder: () => PrePrayerScreen(prayer: next)),
),
child: Container(
width: double.infinity,
padding: const EdgeInsets.all(18),
...
decoration: BoxDecoration(
color: filled ? AppColors.surfaceDark.withOpacity(0.7) : Colors.transparent,
border: Border.all(color: AppColors.gold.withOpacity(0.5)),
borderRadius: BorderRadius.circular(30),
),
child: Row(
