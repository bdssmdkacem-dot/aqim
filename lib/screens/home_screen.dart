    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            if (state.cityName != null || !state.notificationsActive)
              Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 15,
                        color: state.notificationsActive ? AppColors.textMuted : AppColors.ember,
                      ),
                      ...
                      Expanded(
                        child: Text(
                          state.notificationsActive
                              ? (state.cityName ?? '')
                              : 'الإشعارات غير مفعّلة — اضغط لمعرفة السبب',
                          style: TextStyle(
                            fontSize: 12,
                            color: state.notificationsActive ? AppColors.textMuted : AppColors.ember,
                            fontWeight: state.notificationsActive ? FontWeight.w400 : FontWeight.w600,
                          ),
                        ),
                      ),
                    ],
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'صلاة ${next.arabicName} — ${state.displayTimeFor(next)}',
