...
class _BottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    decoration: const BoxDecoration(color: AppColors.surfaceDark, border: Border(top: BorderSide(color: AppColors.paperLine))),
    child: SafeArea(top: false, child: SizedBox(height: 66, child: Row(children: [
...
class _NavItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(child: InkWell(onTap: onTap, child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
...
class _CenterButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Expanded(child: Transform.translate(
    offset: const Offset(0, -14),
    child: Column(mainAxisSize: MainAxisSize.min, children: [
      InkWell(onTap: onTap, borderRadius: BorderRadius.circular(32), child: Container(
        width: 54, height: 54,
        decoration: BoxDecoration(color: AppColors.gold, shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.35), blurRadius: 10, offset: const Offset(0, 3))]),
