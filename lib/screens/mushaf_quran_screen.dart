...
class _MushafQuranScreenState extends State<MushafQuranScreen> {
  ...
  String get _key =>
      _riwaya == MushafRiwaya.hafs ? 'quran_hafs_page' : 'quran_warsh_page';
  String get _resumeKey => 'quran_resume_page_$_riwayaName';
  String get _nextKey => 'quran_next_page_$_riwayaName';
  String get _label =>
      _riwaya == MushafRiwaya.hafs ? 'حفص عن عاصم' : 'ورش عن نافع';
  String get _folder => _riwaya == MushafRiwaya.hafs ? 'hafs' : 'warsh';

  static const List<_Surah> _surahs = [
    _Surah(1, 'الفاتحة', 1),
    _Surah(2, 'البقرة', 2),
    _Surah(3, 'آل عمران', 50),
    _Surah(4, 'النساء', 77),
    _Surah(5, 'المائدة', 106),
    _Surah(6, 'الأنعام', 128),
    _Surah(7, 'الأعراف', 151),
    _Surah(8, 'الأنفال', 177),
    _Surah(9, 'التوبة', 187),
    _Surah(10, 'يونس', 208),
    _Surah(11, 'هود', 221),
    _Surah(12, 'يوسف', 235),
    _Surah(13, 'الرعد', 249),
    _Surah(14, 'إبراهيم', 255),
    _Surah(15, 'الحجر', 262),
    _Surah(16, 'النحل', 267),
    _Surah(17, 'الإسراء', 282),
    _Surah(18, 'الكهف', 293),
    _Surah(19, 'مريم', 305),
    _Surah(20, 'طه', 312),
    _Surah(21, 'الأنبياء', 322),
    _Surah(22, 'الحج', 332),
    _Surah(23, 'المؤمنون', 342),
    _Surah(24, 'النور', 350),
    _Surah(25, 'الفرقان', 359),
    _Surah(26, 'الشعراء', 367),
    _Surah(27, 'النمل', 377),
    _Surah(28, 'القصص', 385),
    _Surah(29, 'العنكبوت', 396),
    _Surah(30, 'الروم', 404),
    _Surah(31, 'لقمان', 411),
    _Surah(32, 'السجدة', 415),
    _Surah(33, 'الأحزاب', 418),
    _Surah(34, 'سبأ', 428),
    _Surah(35, 'فاطر', 434),
    _Surah(36, 'يس', 440),
    _Surah(37, 'الصافات', 446),
    _Surah(38, 'ص', 453),
    _Surah(39, 'الزمر', 458),
    _Surah(40, 'غافر', 467),
    _Surah(41, 'فصلت', 477),
    _Surah(42, 'الشورى', 483),
    _Surah(43, 'الزخرف', 489),
    _Surah(44, 'الدخان', 496),
    _Surah(45, 'الجاثية', 499),
    _Surah(46, 'الأحقاف', 502),
    _Surah(47, 'محمد', 507),
    _Surah(48, 'الفتح', 511),
    _Surah(49, 'الحجرات', 515),
    _Surah(50, 'ق', 518),
    _Surah(51, 'الذاريات', 520),
    _Surah(52, 'الطور', 523),
    _Surah(53, 'النجم', 526),
    _Surah(54, 'القمر', 528),
    _Surah(55, 'الرحمن', 531),
    _Surah(56, 'الواقعة', 534),
    _Surah(57, 'الحديد', 537),
    _Surah(58, 'المجادلة', 542),
    _Surah(59, 'الحشر', 545),
    _Surah(60, 'الممتحنة', 549),
    _Surah(61, 'الصف', 551),
    _Surah(62, 'الجمعة', 553),
    _Surah(63, 'المنافقون', 554),
    _Surah(64, 'التغابن', 556),
    _Surah(65, 'الطلاق', 558),
    _Surah(66, 'التحريم', 560),
    _Surah(67, 'الملك', 562),
    _Surah(68, 'القلم', 564),
    _Surah(69, 'الحاقة', 566),
    _Surah(70, 'المعارج', 568),
    _Surah(71, 'نوح', 570),
    _Surah(72, 'الجن', 572),
    _Surah(73, 'المزمل', 574),
    _Surah(74, 'المدثر', 575),
    _Surah(75, 'القيامة', 577),
    _Surah(76, 'الإنسان', 578),
    _Surah(77, 'المرسلات', 580),
    _Surah(78, 'النبأ', 582),
    _Surah(79, 'النازعات', 583),
    _Surah(80, 'عبس', 585),
    _Surah(81, 'التكوير', 586),
    _Surah(82, 'الانفطار', 587),
    _Surah(83, 'المطففين', 587),
    _Surah(84, 'الانشقاق', 589),
    _Surah(85, 'البروج', 590),
    _Surah(86, 'الطارق', 591),
    _Surah(87, 'الأعلى', 591),
    _Surah(88, 'الغاشية', 592),
    _Surah(89, 'الفجر', 593),
    _Surah(90, 'البلد', 594),
    _Surah(91, 'الشمس', 595),
    _Surah(92, 'الليل', 595),
    ...
    _Surah(96, 'العلق', 597),
    _Surah(97, 'القدر', 598),
    _Surah(98, 'البينة', 598),
    _Surah(99, 'الزلزلة', 599),
    _Surah(100, 'العاديات', 599),
    _Surah(101, 'القارعة', 600),
    _Surah(102, 'التكاثر', 600),
    _Surah(103, 'العصر', 601),
    _Surah(104, 'الهمزة', 601),
    _Surah(105, 'الفيل', 601),
    _Surah(106, 'قريش', 602),
    _Surah(107, 'الماعون', 602),
    _Surah(108, 'الكوثر', 602),
    _Surah(109, 'الكافرون', 603),
    _Surah(110, 'النصر', 603),
    _Surah(111, 'المسد', 603),
    _Surah(112, 'الإخلاص', 604),
    _Surah(113, 'الفلق', 604),
    _Surah(114, 'الناس', 604),
  ];
  ...
  Future<void> _switchRiwaya(MushafRiwaya value) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    final key =
        value == MushafRiwaya.hafs ? 'quran_hafs_page' : 'quran_warsh_page';
    final saved = (prefs.getInt(key) ??
            prefs.getInt('quran_resume_page_${value.name}') ??
            1)
        .clamp(1, pageCount)
        .toInt();
              ...
              child: Center(
                child: Image.asset(
                  ...
                  errorBuilder: (_, __, ___) => const Center(
                    child: Text('صفحة المصحف غير متوفرة',
        ...
        child: Row(
          children: [
            ...
            IconButton(
                ...
                icon:
                    const Icon(Icons.list_alt_rounded, color: AppColors.gold)),
            PopupMenuButton<MushafRiwaya>(
              ...
              itemBuilder: (_) => const [
                PopupMenuItem(
                    value: MushafRiwaya.hafs,
                    child: Text('حفص عن عاصم',
                        style: TextStyle(color: Colors.white))),
                PopupMenuItem(
                    value: MushafRiwaya.warsh,
                    child: Text('ورش عن نافع',
                        style: TextStyle(color: Colors.white))),
              ],
            ),
            IconButton(
