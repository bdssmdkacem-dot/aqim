...
class WeekReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final weekPercents =
        weekDates.map((d) => state.percentForDate(d) ?? 0).toList();
    final average = weekPercents.isEmpty
        ? 0
        : (weekPercents.reduce((a, b) => a + b) / weekPercents.length).round();
    final completedDays = weekPercents.where((v) => v >= 80).length;
    final upcomingEvents =
        ReligiousEventsService.upcoming(from: today, years: 1)
            ...
            children: [
                ...
                child: Row(children: [
                  ...
                  Expanded(
                      child: Column(
                        ...
                        Text('تابع صلاتك يومًا بيوم، وخطوة بخطوة.',
              ...
              if (upcomingEvents.isNotEmpty) ...[
                ...
                Container(
                  decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: AppColors.gold.withOpacity(.24))),
                  child: Column(
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                          '${event.hijri} • $dateLabel${event.provisional ? ' • موعد متوقع' : ''}',
                          style: Theme.of(context).textTheme.bodySmall),
                    );
                  }).toList()),
                ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: AppColors.paperLine.withOpacity(.75))),
                child: Row(
                    ...
                    child: Column(children: [
                      ...
                      Container(
                          ...
                          child: FractionallySizedBox(
                              heightFactor:
                                  (percent / 100).clamp(.08, 1.0).toDouble(),
                              child: Container(
                                  decoration: BoxDecoration(
                                      color: complete
                                          ? AppColors.sage
              ...
              Container(
                ...
                child: Row(children: [
                  const Icon(Icons.today_rounded,
                      color: AppColors.goldSoft, size: 25),
                  const SizedBox(width: 10),
                  Expanded(
                      child: Text(
                          'إنجاز اليوم: $todayPercent% — ${_dayName(today)} ${today.day}/${today.month}',
                ...
                Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          Text(
                              'لاحظنا أن ${weakest.arabicName} هي الصلاة التي تفوتك أكثر من غيرها. هدفك القادم: تحسينها.',
                              style: Theme.of(context).textTheme.bodyMedium)
                        ])),
              ],
              const SizedBox(height: 16),
