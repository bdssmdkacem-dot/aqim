          ...
          Expanded(child: ListView(
            ...
            children: [
              Container(
                ...
                child: Row(children: [
                  Container(width: 52, height: 52, padding: const EdgeInsets.all(7), decoration: BoxDecoration(shape: BoxShape.circle, color: AppColors.gold.withOpacity(.10), border: Border.all(color: AppColors.gold.withOpacity(.55))), child: ClipOval(child: Image.asset('assets/images/aqim_logo_transparent_512.png', fit: BoxFit.contain))),
