      ...
      case 2026:
        return [
          ReligiousEvent(
              ...
              hijri: '1 رمضان 1447 هـ',
              date: DateTime(2026, 2, 19)),
          ReligiousEvent(
              id: 'fitr-1447',
              title: 'عيد الفطر المبارك',
              hijri: '1 شوال 1447 هـ',
              date: DateTime(2026, 3, 20)),
          ReligiousEvent(
              id: 'arafah-1447',
              title: 'يوم عرفة',
              hijri: '9 ذو الحجة 1447 هـ',
              date: DateTime(2026, 5, 26)),
          ReligiousEvent(
              id: 'adha-1447',
              title: 'عيد الأضحى المبارك',
              hijri: '10 ذو الحجة 1447 هـ',
      ...
      case 2027:
        return [
          ReligiousEvent(
              ...
              provisional: true),
          ReligiousEvent(
              id: 'laylat-al-qadr-1448',
              title: 'ليلة القدر',
              hijri: '27 رمضان 1448 هـ',
          ...
          ReligiousEvent(
              ...
              title: 'رأس السنة الهجرية',
              hijri: '1 محرم 1449 هـ',
              date: DateTime(2027, 6, 7),
              provisional: true),
          ReligiousEvent(
              id: 'ashura-1449',
              title: 'عاشوراء',
              hijri: '10 محرم 1449 هـ',
              date: DateTime(2027, 6, 16),
              provisional: true),
          ReligiousEvent(
              id: 'mawlid-1449',
              title: 'المولد النبوي الشريف',
  ...
  static ReligiousEvent? eventOn(DateTime date) {
    for (final event in eventsForYear(date.year)) {
      if (event.date.year == date.year &&
          ...
          event.date.day == date.day) return event;
    }
    return null;
  }
