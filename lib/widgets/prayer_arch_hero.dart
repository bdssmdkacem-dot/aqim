        ...
        return SizedBox(
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned.fill(
                child: IgnorePointer(child: CustomPaint(painter: _ArchBorderPainter())),
              ),
            ],
          ),
        );
  ...
  List<Color> _skyColorsFor(PrayerDayPeriod period) {
    switch (period) {
      case PrayerDayPeriod.dawn:
        return const [Color(0xFF29263D), Color(0xFF684B61), Color(0xFFC58A5A)];
      case PrayerDayPeriod.day:
        return const [Color(0xFF3F769C), Color(0xFF85B4CC), Color(0xFFE5D6AD)];
      case PrayerDayPeriod.sunset:
        return const [Color(0xFF302A45), Color(0xFF955C50), Color(0xFFE2A35B)];
      case PrayerDayPeriod.night:
        return const [Color(0xFF080F28), Color(0xFF111E3D), Color(0xFF1D3450)];
    }
  }
